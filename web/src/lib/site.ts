...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Безналичный расчёт для юрлиц и ИП по договору. Возможна оплата через ЕРИП. Самовывоз с производства в Минске или доставка по согласованию. Реквизиты и шаблон договора — в подвале сайта.",
  },
  {
    q: "Доставка",
    a: "Самовывоз с производства или доставка курьерской службой. Отправляем Европочтой, Белпочтой, АвтолайтЭкспресс. Собственный транспорт — в планах.",
  },
] as const;
