      ...
      <div className="container-site">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-ink-soft sm:text-lg">
            ООО «БОКСМАРТ» — производство гофротарной упаковки в Минске. Работаем с бизнесом
            любого масштаба: от селлеров маркетплейсов до крупных оптовых заказчиков. Точные
            размеры, понятные сроки, цена без лишних звеньев.
          </p>
        </div>
